            ...
            with open("run_parameters.dat", "w") as parameters_file:                
                with open("test_parameters_template.dat", "r") as template_parameters_file:
                    for template_line in template_parameters_file:
                        parameters_file.write(template_line.replace("INSTANCE_NAME", instance_name).replace("CAPT_RADIUS COMM_RADIUS", radius_values).replace("TEMPERATURE_VALUES", temperature_values))
